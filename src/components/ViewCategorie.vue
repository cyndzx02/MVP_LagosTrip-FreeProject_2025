...
export default {
  data() {
    return {
      searchQuery: "",
      items: [
        { name: "Produit 1", price: 10, image: "https://via.placeholder.com/150" },
        { name: "Produit 2", price: 20, image: "https://via.placeholder.com/150" },
        { name: "Produit 3", price: 30, image: "https://via.placeholder.com/150" },
        { name: "Produit 4", price: 40, image: "https://via.placeholder.com/150" },
        { name: "Produit 5", price: 50, image: "https://via.placeholder.com/150" },
        { name: "Produit 6", price: 60, image: "https://via.placeholder.com/150" }
      ]
    };
  },
  computed: {
